...
class Event
        : public TimeStampPolicy, public ReversedPolicy, public DurationPolicy, public IndexPolicy, public KindPolicy {
public:
    nodeindex source;
    nodeindex dest;
...
template<typename TimeStampPolicy, typename ReversedPolicy, typename DurationPolicy, typename IndexPolicy, typename KindPolicy>
bool
Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::operator==(const Event &other) const {
    return (this->source == other.source && this->dest == other.dest && this->isEqualTime(other) &&
            this->isEqualReversed(other) && this->isEqualDuration(other) && this->isEqualIndex(other));
}
...
template<typename TimeStampPolicy, typename ReversedPolicy, typename DurationPolicy, typename IndexPolicy, typename KindPolicy>
void
Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::readFromFile_tsd(ifstream &the_file) {
...
template<typename TimeStampPolicy, typename ReversedPolicy, typename DurationPolicy, typename IndexPolicy, typename KindPolicy>
void
Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::readFromFile_sdt(ifstream &the_file) {
    the_file >> this->source;
    the_file >> this->dest;
    this->readTime(the_file);
}
...
template<typename TimeStampPolicy, typename ReversedPolicy, typename DurationPolicy, typename IndexPolicy, typename KindPolicy>
void
Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::readFromFile_sdtd(ifstream &the_file) {
    the_file >> this->source;
    the_file >> this->dest;
    this->readTime(the_file);
...
template<typename TimeStampPolicy, typename ReversedPolicy, typename DurationPolicy, typename IndexPolicy, typename KindPolicy>
void
Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::readFromFile_all(ifstream &the_file) {
    the_file >> this->source;
    the_file >> this->dest;
...
template<typename TimeStampPolicy, typename ReversedPolicy, typename DurationPolicy, typename IndexPolicy, typename KindPolicy>
void
Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::writeToFile_tsd(ofstream &the_file) {
...
template<typename TimeStampPolicy, typename ReversedPolicy, typename DurationPolicy, typename IndexPolicy, typename KindPolicy>
void
Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::writeToFile_sdt(ofstream &the_file) {
    the_file << this->source;
    the_file << " ";
    the_file << this->dest;
    the_file << " ";
...
template<typename TimeStampPolicy, typename ReversedPolicy, typename DurationPolicy, typename IndexPolicy, typename KindPolicy>
void
Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::writeToFile_sdtd(ofstream &the_file) {
    the_file << this->source;
    the_file << " ";
    the_file << this->dest;
    the_file << " ";
...
template<typename TimeStampPolicy, typename ReversedPolicy, typename DurationPolicy, typename IndexPolicy, typename KindPolicy>
void
Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::writeToFile_all(ofstream &the_file) {
    the_file << this->source;
    the_file << " ";
    the_file << this->dest;
...
template<typename TimeStampPolicy, typename ReversedPolicy, typename DurationPolicy, typename IndexPolicy, typename KindPolicy>
void
Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::copyAllButTime(Event &targetEvent) {
...
//Constructor
template<typename TimeStampPolicy, typename ReversedPolicy, typename DurationPolicy, typename IndexPolicy, typename KindPolicy>
Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::Event()
        : TimeStampPolicy(), ReversedPolicy(), DurationPolicy(), IndexPolicy() {
}

//Copy constructor
template<typename TimeStampPolicy, typename ReversedPolicy, typename DurationPolicy, typename IndexPolicy, typename KindPolicy>
Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::Event(
        const Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy> &event) : TimeStampPolicy(
        event), ReversedPolicy(event), DurationPolicy(event), IndexPolicy(event) {
...
template<typename TimeStampPolicy, typename ReversedPolicy, typename DurationPolicy, typename IndexPolicy, typename KindPolicy>
Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>
Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::getReversedEvent() {
    Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy> newEvent = Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>(
            *this);
...
string Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::getLongEventInformation() {
    stringstream s;
    s << "Event(source: " << this->source << ", dest: " << this->dest << ", " << this->getLongTimeStr() << ", "
      << this->getLongReverseStr() << ", " << this->getLongDurationStr() << ", " << this->getLongIndexStr() << ")";
    return s.str();
}
...
template<typename TimeStampPolicy, typename ReversedPolicy, typename DurationPolicy, typename IndexPolicy, typename KindPolicy>
timestamp Event<TimeStampPolicy, ReversedPolicy, DurationPolicy, IndexPolicy, KindPolicy>::getEndTime() {
...
typedef Event<NoTimeStamp, NoReverse, NoDuration, NoIndex, Kind> Event_K;
...
typedef Event<TimeStamp, Reverse, NoDuration, Index, Kind> Event_TRIK;
typedef Event<TimeStamp, Reverse, Duration, Index, Kind> Event_TRDIK;
typedef Event<TimeStamp, NoReverse, Duration, NoIndex, Kind> Event_TDK;
typedef Event<TimeStamp, NoReverse, Duration, Index, Kind> Event_TDIK;
typedef Event<TimeStamp, NoReverse, NoDuration, Index, Kind> Event_TIK;
typedef Event<NoTimeStamp, Reverse, NoDuration, NoIndex, Kind> Event_RK;
typedef Event<NoTimeStamp, Reverse, Duration, NoIndex, Kind> Event_RDK;
typedef Event<NoTimeStamp, Reverse, NoDuration, Index, Kind> Event_RIK;
typedef Event<NoTimeStamp, Reverse, Duration, Index, Kind> Event_RDIK;
typedef Event<NoTimeStamp, NoReverse, Duration, NoIndex, Kind> Event_DK;
typedef Event<NoTimeStamp, NoReverse, Duration, Index, Kind> Event_DIK;
typedef Event<NoTimeStamp, NoReverse, NoDuration, Index, Kind> Event_IK;
...
typedef Event<TimeStamp, NoReverse, Duration, NoIndex, NoKind> EventWithDurationAndType;


//Comparing events

template<class EventType>
bool compare_sdt(const EventType &event1,
                 const EventType &event2) {//compare 2 events according to the source, then the destination, then the time
...
template<class EventType>
bool compare_std(const EventType &event1,
                 const EventType &event2) {//compare 2 events according to the source, then the time, then the destination
    if (event1.source != event2.source)
        return event1.source < event2.source;
...
template<class EventType>
bool
compare_st(const EventType &event1, const EventType &event2) {//compare 2 events according to the source, then the time
    if (event1.source != event2.source)
        return event1.source < event2.source;
    else
        return event1.getTime() < event2.getTime();
...
template<class EventType>
bool compare_sd(const EventType &event1,
                const EventType &event2) {//compare 2 events according to the source, then the destination
    if (event1.source != event2.source)
        return event1.source < event2.source;
    else
        return event1.dest < event2.dest;
