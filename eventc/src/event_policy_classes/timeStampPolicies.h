...
class NoTimeStamp{
 ...
 protected:
  void readTime(basic_ifstream<char> &the_file);
  void writeTime(basic_ofstream<char> &the_file);
  inline void readTimeConditional(basic_ifstream<char> &the_file){}
  inline void writeTimeConditional(basic_ofstream<char> &the_file){}
  static inline bool isEqualTime(const NoTimeStamp & other) {return true;}
};
