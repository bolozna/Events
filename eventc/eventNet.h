 ...
 * require using the structure of the underlying aggregated network correspoding to the event list.
 */
...
#include <algorithm>
#include "eventList.h"
#include "../../lcelib/Nets.H" // LCELib is used for static networks here
